def student_login():
    ...
    def view_homework():
        ...
        try:
            ...
            pass
        root.geometry("950x400")
        frame2 = tk.LabelFrame(root, bg="#414F4B", text="View Homework", padx=10, pady=10, font=("Verdana", 10, "bold"))
        frame2.grid(row=2, column=1, padx=10, pady=10)
        tk.Button(frame2, text="View All Homework", command=vah, font=("David", 10, "bold")) \
            .grid(row=0, column=0, padx=5, pady=5)
        tk.Button(frame2, text="View Pending Homework", command=vph, font=("David", 10, "bold")) \
            .grid(row=0, column=1, padx=5, pady=5)
        tk.Button(frame2, text="View Submitted Homework", command=vsh, font=("David", 10, "bold")) \
    ...
    def vah():
        ...
        try:
            ...
            pass
        root.geometry("950x400")
        frame2 = tk.LabelFrame(root, bg="#414F4B", text="View All Homework", padx=10, pady=10,
                               font=("Verdana", 10, "bold"))
        frame2.grid(row=2, column=1, padx=10, pady=10)
    ...
    def vph():
        ...
        try:
            ...
            pass
        root.geometry("950x400")
        frame2 = tk.LabelFrame(root, bg="#414F4B", text="View Pending Homework", padx=10, pady=10,
                               font=("Verdana", 10, "bold"))
        frame2.grid(row=2, column=1, padx=10, pady=10)
        tk.Button(frame2, text="Physics", command=p_p_hw, width=25, font=("David", 10, "bold")) \
            .grid(row=0, column=0, padx=5, pady=5)
        tk.Button(frame2, text="Chemistry", command=c_p_hw, width=25, font=("David", 10, "bold")) \
            .grid(row=0, column=1, padx=5, pady=5)
        tk.Button(frame2, text="Maths", command=m_p_hw, width=25, font=("David", 10, "bold")) \
            .grid(row=0, column=2, padx=5, pady=5)
    ...
    tk.Button(frame, text="View Homework", command=view_homework, width=25,
    ...
    tk.Button(frame, text="Report Card", command=report_card, width=25,
